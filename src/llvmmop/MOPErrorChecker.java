...
public class MOPErrorChecker {
	...
	public static void verify(LLVMMOPSpec mopSpec) throws MOPException {
	...
	public static void verifySameEventName(LLVMMOPSpec mopSpec) throws MOPException {
	...
	public static void verifyUniqueEndProgram(LLVMMOPSpec mopSpec) throws MOPException {
		boolean found = false;
	...
	public static void verifyGeneralParametric(LLVMMOPSpec mopSpec) throws MOPException {
