...
public class Tool {
	...
	public static boolean isJavaMOPInJarFile(){
		try {
			Class<?> mainClass = Class.forName("llvmmop.LLVMMOPMain");
	...
	public static String getConfigPath(){
		...
		try {
			...
			if (mainClassPath.endsWith(".jar!/llvmmop/LLVMMOPMain.class") && mainClassPath.startsWith("jar:")) {
				...
				packageFilePath = mainClassPath.substring("file:".length(), mainClassPath.length() - "/LLVMMOPMain.class".length());
