/* Generated By:JavaCC: Do not edit this line. AspectParser.java */
package llvmmop.parser.aspect_parser;
import java.io.*;
import java.util.*;
...
import llvmmop.parser.astex.aspect.*;

public class AspectParser implements AspectParserConstants {
  private static AspectParser parser;

  public static PointCut parse(InputStream in, String encoding) throws ParseException
  {
    if (parser == null)
    {
      parser = new AspectParser(in, encoding);
    }
    else
    {
      parser.ReInit(in);
    ...
    while (true) {
      ...
      case PUBLIC:
        jj_consume_token(PUBLIC);
          ...
          modifiers [ i ] = AspectModifierSet.addModifier(modifiers [ i ], AspectModifierSet.PUBLIC, token);
        break;
      case STATIC:
        jj_consume_token(STATIC);
          ...
          modifiers [ i ] = AspectModifierSet.addModifier(modifiers [ i ], AspectModifierSet.STATIC, token);
        break;
      case PROTECTED:
        jj_consume_token(PROTECTED);
          ...
          modifiers [ i ] = AspectModifierSet.addModifier(modifiers [ i ], AspectModifierSet.PROTECTED, token);
        break;
      case PRIVATE:
        jj_consume_token(PRIVATE);
          ...
          modifiers [ i ] = AspectModifierSet.addModifier(modifiers [ i ], AspectModifierSet.PRIVATE, token);
        break;
      case FINAL:
        jj_consume_token(FINAL);
          ...
          modifiers [ i ] = AspectModifierSet.addModifier(modifiers [ i ], AspectModifierSet.FINAL, token);
        break;
      case ABSTRACT:
        jj_consume_token(ABSTRACT);
          ...
          modifiers [ i ] = AspectModifierSet.addModifier(modifiers [ i ], AspectModifierSet.ABSTRACT, token);
        break;
      case SYNCHRONIZED:
        jj_consume_token(SYNCHRONIZED);
          ...
          modifiers [ i ] = AspectModifierSet.addModifier(modifiers [ i ], AspectModifierSet.SYNCHRONIZED, token);
        break;
      case NATIVE:
        jj_consume_token(NATIVE);
          ...
          modifiers [ i ] = AspectModifierSet.addModifier(modifiers [ i ], AspectModifierSet.NATIVE, token);
        break;
      case TRANSIENT:
        jj_consume_token(TRANSIENT);
          ...
          modifiers [ i ] = AspectModifierSet.addModifier(modifiers [ i ], AspectModifierSet.TRANSIENT, token);
        break;
      case VOLATILE:
        jj_consume_token(VOLATILE);
          ...
          modifiers [ i ] = AspectModifierSet.addModifier(modifiers [ i ], AspectModifierSet.VOLATILE, token);
        break;
      case STRICTFP:
        jj_consume_token(STRICTFP);
          ...
          modifiers [ i ] = AspectModifierSet.addModifier(modifiers [ i ], AspectModifierSet.STRICTFP, token);
        break;
      default:
        jj_la1[15] = jj_gen;
        jj_consume_token(-1);
...
/* Moved "{" "}" up -- PAT */
  ...
  BodyDeclaration ret;
    if (jj_2_15(2)) {
      ret = Initializer();
      if (isInterface) {if (true) throw new ParseException("An interface cannot have initializers:" + token);}
    } else {
      switch (jj_nt.kind) {
      case ABSTRACT:
      case BOOLEAN:
...
/* Annotation Types. */
  ...
  AnnotationExpr ann;
    ...
    while (true) {
      ...
      case PUBLIC:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.PUBLIC, new llvmmop.parser.main_parser.Token(token));
        }
        catch (llvmmop.parser.main_parser.ParseException e)
        {
      ...
      case STATIC:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.STATIC, new llvmmop.parser.main_parser.Token(token));
        }
        catch (llvmmop.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token + ":" + e.getMessage());}
      ...
      case PROTECTED:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.PROTECTED, new llvmmop.parser.main_parser.Token(token));
        }
        catch (llvmmop.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token + ":" + e.getMessage());}
      ...
      case PRIVATE:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.PRIVATE, new llvmmop.parser.main_parser.Token(token));
        }
        catch (llvmmop.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token + ":" + e.getMessage());}
      ...
      case FINAL:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.FINAL, new llvmmop.parser.main_parser.Token(token));
        }
        catch (llvmmop.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token + ":" + e.getMessage());}
      ...
      case ABSTRACT:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.ABSTRACT, new llvmmop.parser.main_parser.Token(token));
        }
        catch (llvmmop.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token + ":" + e.getMessage());}
      ...
      case SYNCHRONIZED:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.SYNCHRONIZED, new llvmmop.parser.main_parser.Token(token));
        }
        catch (llvmmop.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token + ":" + e.getMessage());}
      ...
      case NATIVE:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.NATIVE, new llvmmop.parser.main_parser.Token(token));
        }
        catch (llvmmop.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token + ":" + e.getMessage());}
      ...
      case TRANSIENT:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.TRANSIENT, new llvmmop.parser.main_parser.Token(token));
        }
        catch (llvmmop.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token + ":" + e.getMessage());}
      ...
      case VOLATILE:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.VOLATILE, new llvmmop.parser.main_parser.Token(token));
        }
        catch (llvmmop.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token + ":" + e.getMessage());}
      ...
      case STRICTFP:
        ...
        try
        {
          modifiers = ModifierSet.addModifier(modifiers, ModifierSet.STRICTFP, new llvmmop.parser.main_parser.Token(token));
        }
        catch (llvmmop.parser.main_parser.ParseException e)
        {
          {if (true) throw new ParseException(token + ":" + e.getMessage());}
  ...
  ClassOrInterfaceType cit;
    ...
    if (extendsMoreThanOne && !isInterface) {if (true) throw new ParseException("A class cannot extend more than one other class: "+ token);}
    {if (true) return ret;}
    throw new Error("Missing return statement in function");
  }
  ...
  ClassOrInterfaceType cit;
    ...
    if (isInterface) {if (true) throw new ParseException("An interface cannot implement other interfaces" + token);}
    {if (true) return ret;}
    throw new Error("Missing return statement in function");
  }
  ...
  public AspectParserTokenManager token_source;
  ...
  public AspectParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public AspectParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new JavaCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new AspectParserTokenManager(jj_input_stream);
    token = new Token();
  ...
  /** Constructor. */
  public AspectParser(java.io.Reader stream) {
  ...
  public AspectParser(AspectParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    token.next = jj_nt = token_source.getNextToken();
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(AspectParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    token.next = jj_nt = token_source.getNextToken();
    jj_gen = 0;
