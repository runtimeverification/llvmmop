...
import llvmmop.parser.ast.visitor.CollectMOPVarVisitor;
...
public class PropertyAndHandlersExt extends ExtNode {
	...
	int propertyId; //will be defined in LLVMMOPSpec
	...
	public void parseMonitoredEvent(HashMap<String, String> codes, String eventStr){
		...
		while (matcher.find()) {
			...
			int k = llvmmop.util.Tool.findBlockEnd(eventStr, matcher.end());
