...
import llvmmop.parser.ast.mopspec.SpecModifierSet;
...
public class LLVMMOPSpecExt extends ExtNode {
	int modifiers;
  ...
  PackageDeclaration packageDeclaration;
	...
	public LLVMMOPSpecExt(PackageDeclaration packagedeclaration, int line, int column, boolean isPublic, int modifiers, String name, List<MOPParameter> parameters, String inMethod, List<ExtendedSpec> extendedSpecs,
                          List<BodyDeclaration> declarations, List<EventDefinitionExt> events, List<PropertyAndHandlersExt> properties) throws llvmmop.parser.main_parser.ParseException {
		super(line, column);
