...
import llvmmop.parser.ast.mopspec.Formula;
...
public class RenameVariableVisitor implements llvmmop.parser.ast.visitor.GenericVisitor<Node, HashMap<String, MOPParameter>> {
	...
	@Override
	public Node visit(LLVMMOPSpec s, HashMap<String, MOPParameter> arg) {
		return null;
	}
