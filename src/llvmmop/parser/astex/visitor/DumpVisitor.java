...
import llvmmop.parser.astex.mopspec.EventDefinitionExt;
import llvmmop.parser.astex.mopspec.ExtendedSpec;
import llvmmop.parser.astex.mopspec.FormulaExt;
import llvmmop.parser.astex.mopspec.HandlerExt;
import llvmmop.parser.astex.mopspec.LLVMMOPSpecExt;
import llvmmop.parser.astex.mopspec.PropertyAndHandlersExt;
...
public final class DumpVisitor extends llvmmop.parser.ast.visitor.DumpVisitor implements VoidVisitor<Object> {
	...
	public void visit(MOPSpecFileExt f, Object arg) {
		...
		if (f.getSpecs() != null) {
			for (LLVMMOPSpecExt i : f.getSpecs()) {
				i.accept(this, arg);
				printer.printLn();
			}
		}
	...
	public void visit(LLVMMOPSpecExt s, Object arg) {
		if (s.isPublic())
