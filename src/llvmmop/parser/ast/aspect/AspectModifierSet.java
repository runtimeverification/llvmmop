...
import llvmmop.parser.aspect_parser.ParseException;
import llvmmop.parser.aspect_parser.Token;

/**
 * Class to hold modifiers.
 */
public final class AspectModifierSet {

    private AspectModifierSet() {
    }
    ...
    public static int addModifier(int modifiers, int mod, Token token) throws ParseException {
        if ((modifiers & mod) != 0) {
            throw new ParseException("Duplicated modifier" + token);
        }
        return modifiers |= mod;
    }
