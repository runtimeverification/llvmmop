...
import llvmmop.parser.ast.visitor.CheckThisJoinPointVisitor;
...
// -P
public class LLVMMOPSpec extends Node implements Comparable<LLVMMOPSpec>{
	int modifiers;
	String name;
  PackageDeclaration packageDeclaration;
	...
	public LLVMMOPSpec(PackageDeclaration packageDeclaration, int line, int column, int modifiers, String name, List<MOPParameter> parameters, String inMethod, List<BodyDeclaration> declarations,
                       List<EventDefinition> events, List<PropertyAndHandlers> properties) throws llvmmop.parser.main_parser.ParseException {
		super(line, column);
    this.packageDeclaration = packageDeclaration;
		...
		try {
			...
			throw new llvmmop.parser.main_parser.ParseException(e.getMessage());
		}
  ...
  public PackageDeclaration getPackage() {
	...
	public int compareTo(LLVMMOPSpec o){
