...
import llvmmop.output.combinedaspect.ActivatorManager;
import llvmmop.output.combinedaspect.CombinedAspect;
import llvmmop.output.combinedaspect.GlobalLock;
import llvmmop.output.combinedaspect.MOPStatManager;
...
public class AdviceAndPointCut {
	...
	HashSet<LLVMMOPSpec> specsForActivation = new HashSet<LLVMMOPSpec>();
	HashSet<LLVMMOPSpec> specsForChecking = new HashSet<LLVMMOPSpec>();
	...
	public AdviceAndPointCut(LLVMMOPSpec mopSpec, EventDefinition event, CombinedAspect combinedAspect) throws MOPException {
	...
	public boolean addEvent(LLVMMOPSpec mopSpec, EventDefinition event, CombinedAspect combinedAspect) throws MOPException {
	...
	protected String adviceBody(){
		...
		if(LLVMMOPMain.empty_advicebody){
			...
			for(LLVMMOPSpec spec : specsForActivation){
	...
	public String toString() {
		...
		if(LLVMMOPMain.inline && !isAround){
